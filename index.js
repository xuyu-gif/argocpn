...
const { execSync } = require('child_process');        // 只填写UPLOAD_URL将上传节点,同时填写UPLOAD_URL和PROJECT_URL将上传订阅，科技共享，万人骑
...
const UUID = process.env.UUID || '19d18c6a-43d9-4e41-bc2b-43a703aff875'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
